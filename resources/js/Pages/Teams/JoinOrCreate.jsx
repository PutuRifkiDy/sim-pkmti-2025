...
export default function JoinOrCreate({ auth, flash }) {
    ...
    return (
        <ParticipantLayout user={user} title="Buat Atau Gabung Tim">
            ...
            <div className="shadow flex gap-5 flex-col justify-center items-center bg-white dark:bg-[#181d23] py-10 rounded-[14px]">
                <IconJoinOrCreate />
                <div className="flex flex-col gap-6 justify-center items-center text-center">
                    <div className="flex flex-col gap-2 justify-center items-center">
                        <p className="text-white dark:text-gray-100 font-bold text-[20px] leading-[28px] tracking-[0.03em]">Pendaftaran</p>
                    ...
                    <div className="flex flex-col gap-2">
                        <Link
                            ...
                            className="font-bold bg-[#42A1A4] md:px-48 px-4 py-3 text-[20px] tracking-[0.03em] leading-[26px] rounded-md text-white hover:text-white hover:bg-[#59DFD1] dark:text-gray-100 dark:hover:text-white transition-all duration-300 shadow-[0_0_10px_#42A1A4]"
                        >
                            Buat Tim
                        </Link>
